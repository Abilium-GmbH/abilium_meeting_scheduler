...
#getters
    ...
    def get_title(self):
            for record in self:
                return record.meeting_title

    def get_start_date(self):
        for record in self:
            return record.meeting_start_date

    def get_end_date(self):
        for record in self:
            return record.meeting_end_date

    def get_duration(self):
        for record in self:
            return record.meeting_duration

    def get_location(self):
        for record in self:
            return record.meeting_location

    def get_subject(self):
        for record in self:
            return record.meeting_subject

    def get_repetitions(self):
        for record in self:
            return record.meeting_repetitions

    def get_frequency(self):
        for record in self:
            return record.meeting_frequency

    def get_privacy(self):
        for record in self:
            return record.meeting_privacy

    def get_show_as(self):
        for record in self:
            return record.meeting_show_as